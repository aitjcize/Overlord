    ...
    >
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div>
          <button
            type="submit"
            class="w-full mt-2 px-4 py-3 text-sm font-medium text-white bg-emerald-600 rounded-md hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-800 disabled:opacity-50 disabled:cursor-not-allowed"
            :disabled="authStore.loading"
          >
