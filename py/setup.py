...
if "install" in sys.argv or "develop" in sys.argv:
  ...
  try:
    ...
    print(
        "pip install git+https://github.com/aitjcize/WebSocket-for-Python.git")
...
setup(
    ...
    py_modules=[
        "ovl", "ghost", "update_ui_status", "relay_overlord_discovery_packet",
        "stream_camera"
    ],
    entry_points={
        "console_scripts": [
            ...
            "relay_overlord_discovery_packet:main",
    ...
    dependency_links=[
        ...
        "WebSocket-for-Python/tarball/"
        "master#egg=ws4py-0.5.1"
    ],
)
